import { createContext, forwardRef, useContext, createElement, Fragment, useRef, useLayoutEffect } from 'react';
  ...
  withEmotionCache = function withEmotionCache(func) {
    return function (props) {
      ...
      if (cache === null) {
        ...
        cache = createCache();
        return createElement(EmotionCacheContext.Provider, {
          value: cache
        }, func(props, cache));
      } else {
...
withEmotionCache(function (props, cache) {
  ...
  if (!isBrowser) {
    ...
    return createElement("style", (_ref = {}, _ref["data-emotion-" + cache.key] = serializedNames, _ref.dangerouslySetInnerHTML = {
      __html: rules
...
withEmotionCache(function (props, cache) {
  ...
  if (!isBrowser && rules.length !== 0) {
    ...
    return createElement(Fragment, null, createElement("style", (_ref = {}, _ref["data-emotion-" + cache.key] = serializedHashes.substring(1), _ref.dangerouslySetInnerHTML = {
      __html: rules
    }, _ref.nonce = cache.sheet.nonce, _ref)), ele);
  }
